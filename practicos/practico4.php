...
<body>
    ...
    <ol>
        ...
        <li>
            ...
            <p>Son variables que contienen información específica del servidor, de las distintas peticiones que se realizan e inclusive del mismo script php. Algunos ejemplos son:
            <ul>
                <li>$_POST</li>
                <li>$_GET</li>
                <li>$_REQUEST</li>
        ...
        <li>
            <p>Analizando las siguientes sentencias:</p>
            <p>$x = 0;</p>
            <p>$x += 5;</p>
            ...
            <p>(Una Opción es la Correcta)</p></li>
